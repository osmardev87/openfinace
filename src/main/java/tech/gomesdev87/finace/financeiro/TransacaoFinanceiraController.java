...
public class TransacaoFinanceiraController {
    ...
    public TransacaoFinanceiraController(TransacaoFinanceiraService transacaoService, Token tokenService) {
    ...
    public ResponseEntity<TransacaoFinanceira> criar(
            @Valid @RequestBody TransacaoFinanceiraRequestDTO dto,
            Authentication auth) {
