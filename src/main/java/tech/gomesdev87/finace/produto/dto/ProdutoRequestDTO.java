...
public record ProdutoRequestDTO(@NotBlank(message = "O nome do produto é obrigatório") @Size(
                max = 150,
                message = "O nome do produto não pode exceder 150 caracteres") String nome,

                String descricao,

                @Size(max = 50, message = "O SKU não pode exceder 50 caracteres") String sku, // Pode
                                                                                              // ser
                                                                                              // nulo
                                                                                              // para
                                                                                              // geração
